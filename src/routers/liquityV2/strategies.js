...
const { subLiquityV2LeverageManagement, subLiquityV2CloseToPrice, subLiquityV2LeverageManagementOnPrice, subLiquityV2Payback } = require("../../helpers/liquityV2/strategies");
...
router.post("/leverage-management", async (req, res) => {
    ...
    try {
        const { forkId, owner, market, troveId, triggerRatio, targetRatio, ratioState, bundleId, isVnet } = req.body;
...
router.post("/leverage-management-on-price", async (req, res) => {
    ...
    try {
        const { forkId, owner, market, troveId, price, state, targetRatio, isRepayOnPrice, bundleId, isVnet } = req.body;
...
router.post("/payback", async (req, res) => {
    ...
    try {
        const { forkId, owner, market, troveId, triggerRatio, targetRatio, isVnet } = req.body;
